...
most books on scientific computation, and also in the following references:
  ...
  * For an excellent, in-depth discussion of floating-point numbers and issues of numerical accuracy
    encountered when computing with them, see David Goldberg's paper [What Every Computer Scientist Should Know About Floating-Point Arithmetic](https://people.cs.pitt.edu/~cho/cs1541/current/handouts/goldberg.pdf).
